...
export const getAllTechnologies = async () =>
    await client.get(new GetAllTechnologies(), { include: 'total' });

export const queryTechnology = async (query) =>
    await client.get(new QueryTechnology(), { include: 'total', ...query });
...
export const getAllTechStacks = async () =>
    await client.get(new GetAllTechnologyStacks(), { include: 'total' });

export const queryTechStacks = async (query) =>
    await client.get(new QueryTechStacks(), { include: 'total', ...query });
...
export const queryPosts = async (query) =>
    await client.get(new QueryPosts(), {
        take: 50,
        ...query,
...
export const getPost = async (id, include = "comments") =>
    await client.get(new GetPost(), { id, include });

export const queryLatestOrganizationsPosts = async ({
    organizationId, types, categoryId, is, orderBy, skip, take
}) => {
...
// Post Comments
export const queryPostComments = async (query) =>
    await client.get(new QueryPostComments(), { take: 50, ...query });
...
export const getOrganizationBySlug = async (slug) =>
    await client.get(new GetOrganizationBySlug(), { slug });

export const getOrganizationById = async (id) =>
    await client.get(new GetOrganization(), { id });

export const getOrganizationAdmin = async (id) =>
    await client.get(new GetOrganizationAdmin(), { id });
...
export const updateOrganization = async (args) =>
    await client.put(Object.assign(new UpdateOrganization(), args));

export const deleteOrganization = async (id) =>
    await client.delete(new DeleteOrganization(), { id });
...
// Organization Labels
export const addLabel = async (args) =>
    await client.post(Object.assign(new AddOrganizationLabel(), args));

export const updateLabel = async (args) =>
    await client.put(Object.assign(new UpdateOrganizationLabel(), args));

export const removeLabel = async (organizationId, slug) =>
    await client.delete(new RemoveOrganizationLabel(), { organizationId, slug });
...
export const addMember = async (args) =>
    await client.post(Object.assign(new AddOrganizationMember(), args));

export const updateMember = async (args) =>
    await client.put(Object.assign(new UpdateOrganizationMember(), args));

export const removeMember = async (organizationId, userId) =>
    await client.delete(new RemoveOrganizationMember(), { organizationId, userId });
...
export const getUserOrganizations = async () =>
    await client.get(new GetUserOrganizations());
...
export const getUserPostActivity = async () =>
    await client.get(new GetUserPostActivity());

export const getUserPostCommentVotes = async (postId) =>
    await client.get(new GetUserPostCommentVotes(), { postId });

export const getUsersKarma = async (userIds) =>
    (await client.get(new GetUsersKarma(), { userIds })).results;
